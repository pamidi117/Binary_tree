...
// Function to print binary tree recursively in preorder traversal
void printTreePreorder(Node* root) {
    ...
    printTreePreorder(root->left); // Recursively traverse the left subtree
    printTreePreorder(root->right); // Recursively traverse the right subtree
}
...
int main() {
    ...
    cout << "Binary Tree (Preorder traversal):" << endl; // Print a message indicating the type of traversal
    printTreePreorder(root); // Print the binary tree in preorder traversal
